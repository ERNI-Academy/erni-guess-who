  ...
  useEffect(() => {
    ...
    const handlePlay = () => {
      void trackEvent('video_start', {
        surface: 'home_video_banner',
        video_title: 'ERNI video banner',
        video_url: 'https://www.betterask.erni/wp-content/uploads/2023/11/Header-Home-ERNI.mp4',
  ...
  return (
    <div ref={bannerRef} className="w-full h-[75vh] relative overflow-hidden">
      <video
        ...
        src="https://www.betterask.erni/wp-content/uploads/2023/11/Header-Home-ERNI.mp4"
        autoPlay
        muted
        loop
        playsInline
